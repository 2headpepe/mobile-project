...
class _$_Person implements _Person {
  const _$_Person({required this.info, required final List<Results> results})
      : _results = results;
  ...
  @override
  String toString() {
    return 'Person(info: $info, results: $results)';
  }
...
abstract class _Person implements Person {
  const factory _Person(
      ...
      required final List<Results> results}) = _$_Person;
...
abstract class $ResultsCopyWith<$Res> {
  ...
  $Res call({int id, String name, String gender, String image});
}
...
class _$_Results implements _Results {
  ...
  @override
  String toString() {
    return 'Results(id: $id, name: $name, gender: $gender, image: $image)';
  }
